...
from vri.environments import galaxea_env as _galaxea_env 
...
def vla():
    ...
    runtime = _runtime.Runtime(
        environment=_galaxea_env.GalaxeaEnvironment(reset_position=metadata.get("reset_pose"), instruction=instruction, reset_type=1),
